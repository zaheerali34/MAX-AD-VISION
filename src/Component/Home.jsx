      ...
      <div className="w-full flex items-center justify-center gap-6 mt-[10rem] px-[7rem] ">
        ...
        <div className="w-full">
          ...
          <img
            src="../image/1.jpg"
            alt=""
            className="absolute top-[30rem] w-[25vw] h-[35vw] z-40 rounded-md rotate-6 grayscale"
          />
          <img
            src="../image/2.jpg"
            alt=""
            className=" absolute top-[15rem] right-[5rem] w-[25vw] h-[35vw] z-40 rounded-md rotate-6 grayscale"
          />
        </div>
      </div>
    </>
